...
if(run){
  ...
  ens_plot
  # Save plot
  ggsave(filename = "norm_Norm.jpeg", path = "chap2_order", width = 10.5, height = 7)
  # Get another plot
  ens_plot <- ens_norm %>% order.summary(component = Variance_Norm)
  ens_plot
  # Save plot
  ggsave(filename = "norm_Norm_var.jpeg", path = "chap2_order", width = 10.5, height = 7)
}
```
...
if(run){
  ...
  ens_plot
  # Save plot
  ggsave(filename = "norm_Re.jpeg", path = "chap2_order", width = 10.5, height = 7)
  # Get another plot
  ens_plot <- ens_norm %>% order.summary(component = Variance_Re)
  ens_plot
  # Save plot
  ggsave(filename = "norm_Re_var.jpeg", path = "chap2_order", width = 10.5, height = 7)
}
```
...
if(run){
  ...
  ens_plot
  # Save plot
  ggsave(filename = "sign_Norm.jpeg", path = "chap2_order", width = 10.5, height = 7)
  # Get another plot
  ens_plot <- ens_sign %>% order.summary(component = Variance_Norm)
  ens_plot
  # Save plot
  ggsave(filename = "sign_Norm_var.jpeg", path = "chap2_order", width = 10.5, height = 7)
}
```
...
if(run){
  ...
  ens_plot
  # Save plot
  ggsave(filename = "sign_Re.jpeg", path = "chap2_order", width = 10.5, height = 7)
  # Get another plot
