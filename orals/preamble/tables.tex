...
\newcommand{\Ddisttable}{
  \begin{tabular}{ |p{1.75cm}||p{2.25cm}|p{2.5cm}|p{2.25cm}|  }
   \hline
...
\newcommand{\pairingschemetableNOIJ}{
  %\begin{tabular}{ |p{2.5cm}||p{1.75cm}|p{5.5cm}|  }
  %\begin{center}
    \begin{tabular}{ |p{3cm}||p{3cm}|p{6cm}|  }
     \hline
     ...
     Consecutive  & $\Pi_C$ & $\{(i,j) \mid i = j + 1 \}$ \\
     All & $\Pi_0$ & $\{(i,j)\}$ \\
     \hline
    \end{tabular}
  %\end{center}
