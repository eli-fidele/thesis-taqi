...
For $\beta$-ensembles, we mention the invariance criterion, which is defined in lieu of the following groups.
...
A reference for the following theorem can be found in (Ref).
