...
This is a simple Markov chain with two characterizing parameters: the number of vertices, and the weights between each vertex.
...
Please refer to [\cite{blitz}], Chapter 11 for all this information.
