...
% A useful addition
\newcommand{\epitextfont}{\upshape}
\newcommand{\episourcefont}{\upshape}

\makeatletter
\newsavebox{\epi@textbox}
\newsavebox{\epi@sourcebox}
\newlength\epi@finalwidth
\newcommand{\epigraphSM}[2]{%
  \vspace{\beforeepigraphskip}
  {\small\begin{\epigraphflush}
   \epi@finalwidth=\z@
   \sbox\epi@textbox{%
     \varwidth{0.5\textwidth}
     \begin{flushright}\epitextfont#1\end{flushright}
     \endvarwidth
   }%
   \epi@finalwidth=\wd\epi@textbox
   \sbox\epi@sourcebox{%
     \varwidth{0.5\textwidth}
     \begin{flushright}\episourcefont#2\end{flushright}%
     \endvarwidth
   }%
