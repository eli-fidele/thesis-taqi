...
%=========================================================================================
%
% \newcommand{\FIGUREpairtable}[2]{
%   \begin{figure}[#1]
%    \begin{center}
%     \includegraphics[scale = #2]{../graphics/chap3/3-2_pairtable}
...
% \newcommand{\FIGUREwignernorm}[2]{
%   \begin{figure}[#1]
%    \begin{center}
%     \includegraphics[scale = #2]{../graphics/chap3/3-3_wigner_norm}
%     \caption{Wigner's Surmise for Symmetric Normal Matrices}
%    \end{center}
%    \label{wigner_beta}
%   \end{figure}
% }
