...
\plotwrapperNC{h}{0.6}{../graphics/chap4/beta24_spec}
...
\minititle{Mean Statistics}

\plotwrapperNC{h}{0.4}{../graphics/chap4/betaspec_Norm_mean}

\plotwrapperNC{h}{0.4}{../graphics/chap4/betaspec_Re_mean}

\newpage

\minititle{Variance Statistics}

\plotwrapperNC{h}{0.4}{../graphics/chap4/betaspec_Re_var}
...
In this section, we will briefly discuss the dispersion statistics of the $\b$-ensembles.

%=========================================================================================
\subsection{Order Statistics}
%=========================================================================================

First, we will consider the dispersion $\disp_{\text{abs}}(\Ens \mid \Pi_<)$
...
That being considered, we can use the ranking difference construction just like before to parse this graph.
