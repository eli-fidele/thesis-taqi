...
\blocktitle{Low Repulsion, High Temperature} As $\b \to 0$, the temperature of the system $T \to \infty$.
...
Now, we have thoroughly characterized, interpreted, and explained the $\b$-ensemble.
...
\trim
\plotwrapperNC{h}{0.49}{../graphics/chap4/beta24_spec}
