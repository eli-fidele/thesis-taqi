...
Simply put, a non-homogenous explicit $D$-distribution can be completely characterized by listing the distributions of every entry. However, in this thesis, there are only one application of this that imposes a different
