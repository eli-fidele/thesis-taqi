...
\plotwrapper{h}{0.5}{../graphics/chap2/2-2-1_spec_order12}{Largest eigenvalues distribution}

\newpage

Now, consider the densities at each order $i$:

\plotwrapper{h}{0.45}{../graphics/chap2/2-2-1_spec_order_density}{Distibution of Eigenvalues by Order Statistic}


And consider the variances:

\plotwrapper{h}{0.35}{../graphics/chap2/2-2-1_spec_order_summary}{Distibution of Eigenvalues by Order Statistic}
