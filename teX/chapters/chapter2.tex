...
\plotwrapper{h}{0.4}{../graphics/chap2_order/norm_Norm}{Largest eigenvalues distribution}

\plotwrapper{h}{0.4}{../graphics/chap2_order/norm_Norm_var}{Largest eigenvalues distribution}

\newpage

\plotwrapper{h}{0.4}{../graphics/chap2_order/norm_Re}{Largest eigenvalues distribution}

\plotwrapper{h}{0.4}{../graphics/chap2_order/norm_Re_var}{Largest eigenvalues distribution}

\newpage

\minititle{Sign-Ordered}

\plotwrapper{h}{0.5}{../graphics/chap2_order/sign_Norm}{Largest eigenvalues distribution}

\newpage

\plotwrapper{h}{0.5}{../graphics/chap2_order/sign_Norm_var}{Largest eigenvalues distribution}

\newpage

\plotwrapper{h}{0.5}{../graphics/chap2_order/sign_Re}{Largest eigenvalues distribution}

%\newpage

%\plotwrapper{h}{0.5}{../graphics/chap2_order/sign_Re_var}{Largest eigenvalues distribution}
