...
\begin{definition}[Normalized Largest Eigenvalue]
...
\begin{definition}[Tracy-Widom Distribution]
Suppose $\E$ is an ensemble of $\D$-distributed $N \times N$ matrices of size $K$. The Tracy-Widom distribution of $\E$ is given by taking the set of the largest normalized eigenvalues for every matrix ensemble. That is, the Tracy-Widom distribution is the set $\{ \widetilde{\lambda_{1,i}}\}_{i=1}^K$.
\end{definition}
