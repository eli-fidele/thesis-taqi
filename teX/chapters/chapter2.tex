...
\blocktitle{Expectation} $\E(\lambda_{i} \mid i)$

\blocktitle{Variance} $\Var(\lambda_{i} \mid i)$.
...
\plotwrapper{h}{0.45}{../graphics/chap2_order/sign_Re_var}{Largest eigenvalues distribution}

%=========================================================================================
%=========================================================================================
\newpage
\section{Various Ensemble Spectra}
