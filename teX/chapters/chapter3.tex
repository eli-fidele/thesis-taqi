...
\blocktitle{Sufficiency of Consecutive Pairs} Recall from previously that with respect to the identity difference, some elements of the dispersion $\Delta_\d(P)$ can be expressed as a linear combination of other elements.
